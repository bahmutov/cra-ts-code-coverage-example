...
Name | Description
--- | ---
![cypress version](https://img.shields.io/badge/cypress-4.10.0-brightgreen) | Cypress test runner [cypress-io/cypress](https://github.com/cypress-io/cypress)
![@cypress/instrument-cra version](https://img.shields.io/badge/@cypress/instrument--cra-1.3.1-brightgreen) | Instruments `react-scripts` applications on the fly
